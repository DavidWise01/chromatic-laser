...
the credit returns to the human. ROOT0-ATTRIBUTION-v1.0 · CC-BY-ND-4.0
"""
...
---
ROOT0-ATTRIBUTION-v1.0 · {m['name']} · {COMPANY} (original) · {CARBON} · CC-BY-ND-4.0
""", encoding="utf-8")
...
{m.get('endmark','')}
ROOT0-ATTRIBUTION-v1.0 · CC-BY-ND-4.0
""", encoding="utf-8")
